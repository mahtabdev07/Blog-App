...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-[linear-gradient(94deg,#ff7f00,#FF5000)] text-primary-foreground shadow-xs hover:bg-[linear-gradient(94deg,#FF5000,#ff4500)]",
        destructive:
        ...
        secondary: `
          bg-white/20
          border border-[hsla(0,0%,100%,0.33)] 
          text-[#faf8f8] 
          rounded-[12px] 
          shadow-[0_8px_4px_#2c1f1605,0_4px_4px_#2c1f1614,0_1px_4px_#2c1f161f] 
          backdrop-blur-xl 
          hover:bg-white/25
          inline-flex 
          px-4 py-2 
      ...
      size: { 
        default: "h-11 text-md font-normal px-4 py-2 has-[>svg]:px-3",
        sm: "h-8 rounded-md gap-1.5 px-3 has-[>svg]:px-2.5",
        lg: "h-11 rounded-md text-md font-normal px-2 has-[>svg]:px-4 rounded-lg",
        icon: "size-9",
      },
    },
    defaultVariants: {
